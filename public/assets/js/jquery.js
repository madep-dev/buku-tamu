...
!(function (e, t) {
        ...
        if ((t = x.relative[e[s].type])) c = [K(J(c), t)];
          ...
          if ((t = x.filter[e[s].type].apply(null, e[s].matches))[k]) {
            ...
            return ee(
              1 < s && J(c),
              1 < s &&
                G(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(
                  ve,
                  "$1"
                ),
              t,
    ...
    function re(e, t, n, r) {
      ...
      if (((n = n || []), 1 === c.length)) {
        ...
        while (i--) {
          ...
          if (
            (u = x.find[s]) &&
            (r = u(a.matches[0].replace(H, q), (P.test(o[0].type) && X(t.parentNode)) || t))
          ) {
      ...
      return (l || ne(e, c))(r, t, !C, n, !t || (P.test(e) && X(t.parentNode)) || t), n;
    }
  ...
  (ce.filter = function (e, t, n) {
    ...
    ce.fn.extend({
      ...
      is: function (e) {
        return !!C(this, "string" == typeof e && w.test(e) ? ce(e) : e || [], !1).length;
      },
    });
  var E,
    k = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  ((ce.fn.init = function (e, t, n) {
    ...
    if (((n = n || E), "string" == typeof e)) {
      if (
        !(r =
          "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : k.exec(e)) ||
        (!r[1] && t)
      )
      ...
      if (r[1]) {
        if (
          ...
          ce.merge(this, ce.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : m, !0)),
                        ...
                        (t = e && ("object" == typeof e || "function" == typeof e) && e.then),
                          v(t)
                            ? s
                              ...
                              : (u++,
                                t.call(e, l(u, o, L, s), l(u, o, j, s), l(u, o, L, o.notifyWith)))
                      ...
                      : function () {
                          try {
                            ...
                            ce.Deferred.exceptionHook && ce.Deferred.exceptionHook(e, t.error),
                              u <= i + 1 &&
                                (a !== j && ((n = void 0), (r = [e])), o.rejectWith(n, r));
                          }
                        };
                  i
                    ? t()
  ...
  (ce.fn.ready = function (e) {
    ...
    "complete" === m.readyState || ("loading" !== m.readyState && !m.documentElement.doScroll)
      ...
      : (m.addEventListener("DOMContentLoaded", q), ie.addEventListener("load", q));
  ...
  (Ce.tbody = Ce.tfoot = Ce.colgroup = Ce.caption = Ce.thead),
    (Ce.th = Ce.td),
    le.option || (Ce.optgroup = Ce.option = [1, "<select multiple='multiple'>", "</select>"]);
  var Se = /<|&#?\w+;/;
        ...
        (ce.event.special[i] = {
          setup: function () {
            var e = this.ownerDocument || this.document || this,
              ...
              n = _.get(t, i);
            n || (m.documentMode ? this.addEventListener(i, o) : e.addEventListener(r, o, !0)),
              _.set(t, i, (n || 0) + 1);
          },
          teardown: function () {
            var e = this.ownerDocument || this.document || this,
            ...
            n
              ? _.set(t, i, n)
              : (m.documentMode ? this.removeEventListener(i, o) : e.removeEventListener(r, o, !0),
                _.remove(t, i));
          },
        });
    }),
  ...
  function Be(n, r, i, o) {
    ...
    if (
      ...
      for (s = (a = ce.map(Ee(e, "script"), Me)).length; c < f; c++)
        (u = e),
          c !== d && ((u = ce.clone(u, !0, !0)), s && ce.merge(a, Ee(u, "script"))),
          i.call(n[c], u, c);
      if (s)
  ...
  function Fe(e, t, n) {
    for (var r, i = t ? ce.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || ce.cleanData(Ee(r)),
        r.parentNode && (n && J(r) && ke(Ee(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  ce.extend({
      ...
      "margin" === n && (l += ce.css(e, n + G[a], !0, i)),
        r
          ? ("content" === n && (u -= ce.css(e, "padding" + G[a], !0, i)),
            "margin" !== n && (u -= ce.css(e, "border" + G[a] + "Width", !0, i)))
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          u = _e.test(t),
          l = e.style;
        if ((u || (t = Je(s)), (a = ce.cssHooks[t] || ce.cssHooks[s]), void 0 === n))
      ...
      attr: function (e, t, n) {
        ...
        if (3 !== o && 8 !== o && 2 !== o)
          return "undefined" == typeof e.getAttribute
            ? ce.prop(e, t, n)
            : ((1 === o && ce.isXMLDoc(e)) ||
                (i = ce.attrHooks[t.toLowerCase()] || (ce.expr.match.bool.test(t) ? st : void 0)),
              void 0 !== n
                ? null === n
    ...
    trigger: function (e, t, n, r) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          ...
          (u = p.indexOf(":") < 0 && "on" + p),
          ((e = e[ce.expando] ? e : new ce.Event(p, "object" == typeof e && e)).isTrigger = r
            ? 2
            : 3),
          (e.namespace = h.join(".")),
  ...
  function Tt(n, e, r, i) {
    ...
    if (Array.isArray(e))
      ce.each(e, function (e, t) {
        r || mt.test(n)
          ? i(n, t)
          : Tt(n + "[" + ("object" == typeof t && null != t ? e : "") + "]", t, r, i);
      });
    ...
    (ce.parseHTML = function (e, t, n) {
      return "string" != typeof e
        ...
        : ("boolean" == typeof t && ((n = t), (t = !1)),
          t ||
            (le.createHTMLDocument
              ? (((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href =
                  m.location.href),
